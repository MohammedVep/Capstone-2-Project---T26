...
export default function Home() {
    <>
        <div class="main">
            <div class="header-benefits"><a  href="#">Benefits
            </a>
                <p>
            ...
            <div class="header-pricing"><a  href="#">Pricing
            </a>
                <p>
            ...
            <div class="header-features"><a  href="#">Features
            </a>
                <p>
           ...
           <div class="header-tutoring"><a  href="#">Tutor
            </a>
               <ul>
